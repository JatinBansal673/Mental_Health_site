...
const Card = () => {
  return (
            <div class="feature-grid" className='flex flex-wrap mx-auto gap-5 w-full text-white max-w-[80vw] justify-center'>
                <div class="card" className='max-w-[30vw] border-2 border-black rounded-3xl p-8 flex flex-col justify-center bg-sky-400 max-h-[50vh] content-evenly'>
                    <div class="icon-container" className='mx-auto border-black border-2 rounded-full p-2 bg-yellow-200'>

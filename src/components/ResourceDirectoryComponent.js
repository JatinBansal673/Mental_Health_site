  ...
  return (
    <div className="flex flex-wrap mx-auto gap-6 w-full max-w-[80vw] justify-center mt-8">
      {resources.map((resource, index) => (
        <div
          key={index}
          className={`card max-w-[30vw] border-2 border-black rounded-3xl p-8 flex flex-col ${resource.bgColor} max-h-[50vh] transition-transform duration-200`}
        >
          ...
          <a
            ...
            className="text-white bg-blue-600 px-4 py-2 rounded-full text-center self-start"
          >
            Learn More
          </a>
        </div>
